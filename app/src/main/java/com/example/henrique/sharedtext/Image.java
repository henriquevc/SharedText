...
public class Image extends AppCompatActivity {
    ...
    private List<Bitmap> fotos; /*cada foto adicionada é inserida aqui*/
    ...
    private void configurarMinhaRecycleView (){
        //busca na árvore
    ...
    private View.OnClickListener fabListener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            if (ActivityCompat.checkSelfPermission(Image.this,
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(Image.this,
                    ...
                    Toast.makeText(Image.this,
                            getString(R.string.explicacao_permissao_camera), Toast.LENGTH_SHORT).show();
                }
    ...
    private static class FotosViewHolder extends RecyclerView.ViewHolder{
        ...
        public FotosViewHolder(View raiz) {
            super(raiz);
            this.raiz = raiz;
            this.fotoImageView = raiz.findViewById(R.id.fotoImageView);
        }
    }
    ...
    private class FotosAdapter extends RecyclerView.Adapter<FotosViewHolder> {
        ...
        public FotosViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View raiz = LayoutInflater.from(context).inflate(R.layout.fotos_layout, parent,
                    false);
            FotosViewHolder fotosViewHolder = new FotosViewHolder(raiz);
    ...
    private void setUpFirebase(){
        ...
        this.urlsReference.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                for (DataSnapshot filho : dataSnapshot.getChildren()){
                    ...
                    aux.getBytes(UM_MEGA).addOnSuccessListener(new OnSuccessListener<byte[]>() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            //se falhar
                            Toast.makeText(Image.this, getString(R.string.falha_no_download),
                                    Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Toast.makeText(Image.this, getString(R.string.falha_conexao_fb),
                        Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void uploadImage (final Bitmap image) {
        ...
        task.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(Image.this, getString(R.string.sucesso_no_upload),
                        Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Image.this, getString(R.string.falha_no_upload),
                        Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
        });
